...
"The Weather Site is the first web project that I've worked on using AJAX requests. The site accesses two different APIs that return the city name and weather of the user's location. The site then updates accordingly. I learned a lot about querying different APIs and how to deal with the data that is returned. The link to the website is <a href='http://jarninfang.github.io/weather-app'>here</a>." ];
